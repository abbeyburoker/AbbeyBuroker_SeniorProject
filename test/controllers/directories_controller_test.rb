...
class DirectoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create directory" do
    assert_difference('Directory.count') do
      post directories_url, params: { directory: { depauw_involvement: @directory.depauw_involvement, email: @directory.email, graduation_year: @directory.graduation_year, mentor_experience: @directory.mentor_experience, name: @directory.name } }
    end
  ...
  test "should update directory" do
    patch directory_url(@directory), params: { directory: { depauw_involvement: @directory.depauw_involvement, email: @directory.email, graduation_year: @directory.graduation_year, mentor_experience: @directory.mentor_experience, name: @directory.name } }
